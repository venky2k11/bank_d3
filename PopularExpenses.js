async function init5() {
    ...
    const data = await d3.csv("https://raw.githubusercontent.com/venky2k11/bank_d3/master/data/PopularExpenses.csv", function (d) {
    ...
    function update(data) {
        ...
        var color = d3.scaleOrdinal()
            .domain(res)
            .range(['#ff0000', '#800000', '#8b4513','#f4a460', '#665d1e', '#2c1608', '#ffa500', '#cb410b', '#e3a857', '#b8860b',
                    '#6b8e23', '#4b5320', '#008000', '#006400', '#228b22', '#013220', '#0000ff', '#000080', '#800080', '#9400d3'])
